...
function Placeholder({ label, ready }: { label: string; ready: boolean }) {
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-[radial-gradient(circle_at_30%_20%,#F7E7E4_0%,#EDF1F5_60%)] px-6 text-center">
